...
insert into user (firstname, lastname, email_address, phone_number, password, salt, isvalid, roleid, isactive) values('sunny', 'gym', 'lisalisa2@gmail.com', '4031234560', '9643f56bfa8f4b5ecaba6080b99f3c6aad7b00f31421b4d87a50063184bda852', 'ib1LqMfjfBUB5W2GGAGg/R9kk/KgRfRKKe0Fzh8pjxA=', '1', '2', '1');
...
insert into service values(8, 1,'Lifestyle / Diet Therapy consulting (English, Korean & Japanese)', 'Tai Yang Clinic is happy to provide consulting sessions regarding lifestyle and diet therapy advices in order to maximize the effects of acupuncture treatments in 3 different languages, which are: English, Korean and Japanese ');
        ...
        insert into day(fulldate,year, dayname, daynumber, month_name) values(DATE '2024-05-21', 2024, 'Tuesday', 21, 'May');
         ...
         insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-10', 2024, 'Sunday', 10, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-11', 2024, 'Monday', 11, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-12', 2024, 'Tuesday', 12, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-13', 2024, 'Wednesday', 13, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-14', 2024, 'Thursday', 14, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-15', 2024, 'Friday', 15, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-16', 2024, 'Saturday', 16, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-17', 2024, 'Sunday', 17, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-18', 2024, 'Monday', 18, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-19', 2024, 'Tuesday', 19, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-20', 2024, 'Wednesday', 20, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-21', 2024, 'Thursday', 21, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-22', 2024, 'Friday', 22, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-23', 2024, 'Saturday', 23, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-24', 2024, 'Sunday', 24, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-25', 2024, 'Monday', 25, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-26', 2024, 'Tuesday', 26, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-27', 2024, 'Wednesday', 27, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-28', 2024, 'Thursday', 28, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-29', 2024, 'Friday', 29, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-11-30', 2024, 'Saturday', 30, 'November');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-01', 2024, 'Sunday', 1, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-02', 2024, 'Monday', 2, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-03', 2024, 'Tuesday', 3, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-04', 2024, 'Wednesday', 4, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-05', 2024, 'Thursday', 5, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-06', 2024, 'Friday', 6, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-07', 2024, 'Saturday', 7, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-08', 2024, 'Sunday', 8, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-09', 2024, 'Monday', 9, 'December');
insert into day(fulldate, year, dayname, daynumber, month_name) values(DATE '2024-12-10', 2024, 'Tuesday', 10, 'December');
